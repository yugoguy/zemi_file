; Simple agent-based representation (with extensions) of:
; Cong, L. W., Li, Y., & Wang, N. (2021). Tokenomics: Dynamic adoption and valuation. The Review of Financial Studies, 34(3), 1105-1155.

;Code organization
;; Function Classification
;;; out functions...must be called outside ask[] primitive
;;; in functions...must called inside ask[] primitive
;;; either functions...can be called either inside or outside ask[] primitive
;;; modification not recommended functions...it is recommended not to modify these parts because it has less to do with the agent customization. it may cause error if you change it without fully understanding the code dependency.
;;; modification required functions...functions that require modification if you want to implement your own agent.
;; Variable Classification
;;; fixed variables...no need to reset
;;; reset variables...need to be reset (or should be reset for error proof purpose) after each round
;;; update variables...automatically reset in the process of updating

;v7 changes:
;; using order breeds instead of lists
;; only particiation reward
;; interface adjustments

;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; creating variables accessible from any function (modification may be required)
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
globals [
  ; add global variables freely here↓
  platform-productivity ; update ... value of platform productivity
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; creating agent class to base on & create agent attributes (modification may be required)
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
breed [users user]
...
users-own [
  ...
  transaction-preference ; fixed ... indicates the level of utility the agent experience from the token utility.
  utility-diminish-constant ; fixed ... a Cobb-Douglas constant in the utility function, if in use.
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; main operations: setup and go (modification may be required)
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
to setup ; out
  ...
  ;; for change agent creation, modify create-market function rather than adding code here
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; initializing and resetting the variables (modification may be required)
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
to initialize-variables ; out
  ...
  set platform-productivity 10 ^ log10initial-productivity ; (initial-token-price * potential-token-supply) / (initial-user-base * (sum [exp transaction-preference] of users with [participating? = true])) * ( ( (risk-free-rate - initial-return-belief) / (1 - alpha) ) ^ (1 / alpha) )
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; user agent definition & creation (modification may be required)
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
to define-rational-agents ; in
  ;------------set agent type as identifier if necessary------------
  set agent-type "rational"
  ...
  set utility-diminish-constant 0.25
  set transaction-preference random-normal 0 transaction-need-std
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; agent utility function and optimal token holding amount (modification may be required)
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
to-report utility-function [amount] ; in
  ...
  let holdings-value (last price-record) * amount
  if holdings-value < 0 [
    show "error: negative holdings value"
  ]
  let transactional-benefit ( (holdings-value) ^ (1 - utility-diminish-constant) ) * ( (user-base * platform-productivity * (exp transaction-preference) ) ^ utility-diminish-constant )
  let holdings-governance-value (governance-value) * amount / token-supply * voting
  let expected-return moving-average-return window
  let valuation transactional-benefit - participation-cost - (risk-free-rate * holdings-value) + (expected-return * holdings-value) + holdings-governance-value

  ;------------value output (modification not recommended)------------
  report valuation
end

to-report optimal-token-holdings ; in
  ;------------write comutation of optimal token holdings here that you derived from the utility function------------
  let optimal-amount (user-base * platform-productivity * (exp transaction-preference) / ((last price-record) + 1e-5)) * ((1 - utility-diminish-constant) / (risk-free-rate - (moving-average-return window) - (governance-value * voting / (((last price-record) + 1e-5) * token-supply)))) ^ (1 / utility-diminish-constant)

  ;------------clipping with 0 (modification not recommended)------------
...
to-report moving-average-return [window_length] ; either
  ifelse (length return-record) = 0 [
    ...
    set window_length min list ((length return-record)) window_length
    report mean ( sublist return-record ((length return-record) - window_length) (length return-record) )
  ]
end
...
; Free Space for New Code Lines

;=================================================================


;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; compute platform productivity (modification not recommended)
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
to update-platform-productivity ; out
  ; updated per tick
  set platform-productivity (platform-productivity * exp(((productivity-mu - ((productivity-sigma ^ 2) / 2)) * (1 / (intra-period-trading-rounds * 12))) + (productivity-sigma * (sqrt (1 / (intra-period-trading-rounds * 12))) * (random-normal 0 1))))
end
...
to update-governance-value ; out
  let cashflow user-base * (annual-per-user-revenue / 12 / intra-period-trading-rounds) * scale
...
to update-observer-governance-value ; out
  let present-value-cashflow user-base * (annual-per-user-revenue / 12) * scale / ((1 + annual-discount-rate) ^ (ticks / intra-period-trading-rounds / 12))
  set observer-governance-value observer-governance-value + present-value-cashflow
end

to-report observer-terminal-value ; out
  let final-day-cashflow user-base * (annual-per-user-revenue / 12) * scale
...
to place-orders ; in
  if (random-float 1) < activeness [
    ...
    ifelse wishing-amount > 0 [
      ...
      let valuation ((utility-function ((token-holdings + reward + bid-amount) * scale)) - (utility-function ((token-holdings + reward) * scale))) / (bid-amount * scale) ; naive approach ... linear approximation of valuation per token
      set bid-price max list 1e-5 valuation ; pure valuation approach
      ...
      if wishing-amount < 0 [
        if (token-holdings - locked-holdings) > 0 [
          ...
          let valuation ((utility-function ((token-holdings + reward - ask-amount) * scale)) - (utility-function ((token-holdings + reward) * scale))) / ask-amount * scale
          set ask-price max list 1e-5 valuation ; pure valuation approach
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if ticks > 0 [plot precision platform-productivity 20]"
...
PENS
"reservation price" 1.0 0 -16777216 true "" ";if ticks > 1 [plot token-price]"
...
1315
28
platform productivity parameters
11
0.0
1
